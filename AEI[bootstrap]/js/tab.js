...
function addTab(tabData) {
    var dataHref = tabData.url;
    var dataId = tabData.id;
    var dataTitle = tabData.title;
    ...
    if (addFlag == 0) {9
        ...
        var addIframe = $('.add-tab-container');
        //删除iframe-show
        $("iframe.iframe-show").removeClass("iframe-show");
...
$('.closeAll').on('click', function () {
    ...
    var iframeId = $('iframe[data-id="' + dataId + '"]');
    iframeId.siblings('iframe').remove();
    iframeId.addClass('iframe-show');
